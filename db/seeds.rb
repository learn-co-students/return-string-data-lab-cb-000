...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :description => "fjlksad jf;jkfbjgl; askdhgdfjk hgkjf dnvkl jfdh gkjahs kd;kash gjkfnv,m cnfdksj flk dj sgklf hdjkn", :inventory => Faker::Number.between(0,3))
end
5.times do
